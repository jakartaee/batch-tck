...
#------------------------------------------------------------------------------
# Running Jakarta Batch TCK Version 2.1.0-M2-SNAPSHOT against com.ibm.jbatch 2.0.0
#
...
TCK_ARTIFACT_ID=jakarta.batch.official.tck-2.1.0-M2-SNAPSHOT

#
# STAGED
#

#TCK_DOWNLOAD_URL=https://repo1.maven.org/maven2/jakarta/batch/jakarta.batch.official.tck/2.1.0-M2-SNAPSHOT/$TCK_ARTIFACT_ID.zip
#TCK_DOWNLOAD_URL=https://oss.sonatype.org/content/repositories/staging/jakarta/batch/jakarta.batch.official.tck/2.1.0-M2-SNAPSHOT/$TCK_ARTIFACT_ID.zip
...
#
#TCK_DOWNLOAD_URL=https://download.eclipse.org/jakartaee/batch/2.0/jakarta.batch.official.tck-2.1.0-M2-SNAPSHOT.zip
