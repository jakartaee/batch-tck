...
TCK_ARTIFACT_ID=jakarta.batch.official.tck-2.0.0-M4

#
# STAGED
#
TCK_DOWNLOAD_URL=https://download.eclipse.org/jakartabatch/tck/eftl/$TCK_ARTIFACT_ID.zip
TCK_DOWNLOAD_URL=https://oss.sonatype.org/content/repositories/staging/jakarta/batch/jakarta.batch.official.tck/2.0.0-M4/$TCK_ARTIFACT_ID.zip
TCK_DOWNLOAD_URL=https://repo1.maven.org/maven2/jakarta/batch/jakarta.batch.official.tck/2.0.0-M4/$TCK_ARTIFACT_ID.zip
...
:$TCK_HOME_DIR/tckdir/prereqs/$TCK_ARTIFACT_ID/lib/jakarta.enterprise.cdi-api-3.0.0-M4.jar\
