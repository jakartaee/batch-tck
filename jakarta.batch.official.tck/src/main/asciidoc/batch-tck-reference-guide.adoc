...
Other useful information and links can be found on the eclipse.org project home page for the Jakarta Batch project [https://projects.eclipse.org/projects/ee4j.batch] and also at the GitHub repository home for the specification project [https://github.com/jakartaee/batch].
...
Challenges will be tracked via the https://github.com/jakartaee/batch/issues[issues] of the Jakarta Batch Specification repository.

As a shortcut through the challenge process mentioned in the *Jakarta EE TCK Process 1.1* you can click https://github.com/jakartaee/batch/issues/new?labels=challenge[here], though it is recommended that you read through the challenge process to understand it in detail.
...
Certifications will be tracked via the https://github.com/jakartaee/batch/issues[issues] of the Jakarta Batch Specification repository.

As a shortcut through the certification of compatibility process mentioned in the *Jakarta EE TCK Process 1.1* you can click https://github.com/jakartaee/batch/issues/new?labels=certification[here], though it is recommended that you read through the certification process to understand it in detail.
...
* Jakarta Batch specification/API repository - https://github.com/jakartaee/batch
...
=== Add support for Java 21 (still against Jakarta Batch 2.1) for EE 11
