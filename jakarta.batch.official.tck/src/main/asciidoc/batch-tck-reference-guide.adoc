...
* The Jakarta Batch API JAR under test `jakarta.batch-api-2.0.0-M4.jar`
...
. Your 'java' executable and your 'rt.jar' come from a Java 8 JDK/JRE, since in the example you are running against the Java 8 signature file (based on the -filename argument)
    ...
    -classpath ../jakarta.batch-api-2.0.0-M4.jar:$JAVA_HOME/jre/lib/rt.jar:lib/jakarta.inject-api-1.0.jar:lib/jakarta.enterprise.cdi-api-2.0.1.jar
...
So to be clear, the directory structure looks like
    ...
    jakarta.batch.official.tck-x.y.z/
        ...
        ... as detailed above ...
        ...
    jakarta.batch-api-2.0.0-M4.jar
    sigtestdev.jar
